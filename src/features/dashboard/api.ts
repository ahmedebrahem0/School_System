export { useGetAdminUsersQuery } from "@/features/admin/api";
export { useGetAttendancesQuery } from "@/features/attendances/api";
export { useGetClassesQuery } from "@/features/classes/api";
